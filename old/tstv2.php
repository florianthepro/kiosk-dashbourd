...
let fw=fieldset("Widgets (selection)");
let note=document.createElement("div");note.className="small";note.textContent="Widget actions (Add/Dup/Del/Front/Back) are in the Editor toolbar.";
fw.appendChild(note);
