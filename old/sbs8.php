...
if(bDel)bDel.disabled=(data.pages.length<=1);
}
...
ctxHide();
if(act==="general"){pagePopShow("General",buildGeneralEditor(getPage()));return;}
if(act==="schedule"){pagePopShow("Schedule",buildScheduleEditor(getPage().id));return;}
if(act==="rename"){renamePopShow();return;}
if(act==="duplicate"){dupPage(ctxPageIndex);return;}
if(act==="delete"){if(data.pages.length<=1)return;if(confirm("Delete page?"))delPage(ctxPageIndex);return;}
};
