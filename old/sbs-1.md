...
</html>""" wie verschiebe ich die funktionen von general und von schedule zusammen mit den funktionen rename/dupliziren/löschen auf der page in ein kontext menü (kontextklick auf eine page in pages). (Save/import/export) soll in in die leiste zu Pages/editor aber in die mitte.(damit soll auf den pages in pages nur die beiden pfeile bleiben. gebe mir sauber welche ganzen codeblöcke wie verändert werden sollen.
