...
document.addEventListener("click",()=>ctxHide(),true);
...
ctxHide();
if(act==="general"){pi=i;setMode("editor");setTab("page");renderAll();return;}
if(act==="schedule"){pi=i;setMode("editor");setTab("schedule");renderAll();return;}
...
let row=document.createElement("div");row.className="pg"+(i===pi?" active":"");row.onclick=()=>{pi=i;selectedIds=[];renderAll();};row.oncontextmenu=e=>ctxShow(e,i);
...
acts.appendChild(bUp);acts.appendChild(bDn);
