...
</style></head><body><div id=wrap><div id=scale><div id=baseStage class=stage><div class=bgWrap><div id=baseBgA class=bg></div><div id=baseBgB class=bg></div></div><div id=baseLayer class=layer></div></div><div id=overlayStage class=stage><div class=bgWrap><div id=ovBgA class=bg></div><div id=ovBgB class=bg></div></div><div id=ovLayer class=layer></div></div></div></div><script>
