...
#main{display:grid;grid-template-columns:250px 1fr 360px;height:calc(100% - 46px)}
#pages{grid-column:1;background:#111827;color:#e5e7eb;overflow:auto;border-right:1px solid #0b1220}
#center{grid-column:2;display:flex;flex-direction:column;min-width:0;background:#0b1220}
#side{grid-column:3;background:#fff;border-left:1px solid #d1d5db;overflow:auto}
...
#canvas{position:relative;margin:0;background:#111827;border:1px solid #1f2a44;border-radius:10px}
...
#pagesPanel{display:block}
#editorPanel{display:none;height:100%;flex-direction:column}
body.modePages #pagesPanel{display:block}
body.modePages #editorPanel{display:none}
body.modeEditor #pagesPanel{display:none}
body.modeEditor #editorPanel{display:flex}
#editorPanel .bar{display:flex;gap:6px;flex-wrap:wrap}
...
#widgetListLeft{padding:6px;overflow:auto;flex:1}
...
.wli .t{flex:1;min-width:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
