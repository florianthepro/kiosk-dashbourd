...
#canvasWrap:after{content:"";position:absolute;right:0;top:0;width:10px;height:100%;background:#000;pointer-events:none;z-index:50}
#canvasWrap:before{content:"";position:absolute;left:0;bottom:0;height:10px;width:100%;background:#000;pointer-events:none;z-index:50}
#canvasScale{position:relative;z-index:1}
