...
let tag=document.createElement("div");tag.className="pvTag";tag.textContent=mode;wrap.appendChild(tag);
...
if(mode==="iframe"){fr.src=url;return;}
fr.src=proxyFetchUrl(url);
return;
}
if(w.type==="carousel"){
...
let base={id:uid(),type,x:60,y:60,w:320,h:180,z:nextZ(),locked:false,hidden:false,style:{radius:8,shadow:false,bg:"rgba(255,255,255,.84)",color:"#111827",font:16},src:"",mode:"iframe",text:"",format:"HH:mm:ss",playlist:[]};
